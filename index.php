...
if(isset($_POST['submit'])) {
  ...
  if($_POST['fname']) {
	...
	$subject = '(LifeLongIncome)New lead - '$_POST['fname']" "$_POST['famname'];
	...
	$bodyText = "First Name	: "$_POST['fname']"\nFamily Name: "$_POST['famname']"\nAge Group: "$_POST['agegroup']"\n";
	...
	//	PHPMailer</a> class.</p>';
	$bodyHtml = "<b>First Name</b>	: "$_POST['fname']"\n<b>Family Name</b>: "$_POST['famname']"\n<b>Age Group</b>: "$_POST['agegroup']"\n";
